  ...
  <body>
    ...
    <div class="bodytransition">
      <div class="bodypart">
        ...
        <div class="col"><h2>Add Designation</h2></div>
        <div class="col-auto">
    ...
    <div id="home" class="tab-pane fade in active">
      ...
      <div class="col-sm-4 mb-2">
          ...
          <label class="labelform">Designation</label>
            ...
            <input id="designation" name="designation" class="form-control rounded-0" width="100%" />
        ...
        <div class="col-sm-4 mb-2">
          ...
          <label class="labelform">Status</label>
             ...
             <select id="status"  name="designationStatus" class="form-control rounded-0">
