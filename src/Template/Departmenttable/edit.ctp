...
<html lang="en">
  ...
  <body>
    ...
    <?= $this->Form->create($departmenttable) ?>
    <fieldset>
    <legend><?= __('Edit Departmenttable') ?></legend>
    <!-- body container start here -->
    <input type="hidden" value=<?php echo $_GET['previd']?> name="previd" />
    <div class="bodytransition">
      <div class="bodypart">
        <div class="row pageheadertop mb-3">
        <div class="col"><h2>Edit Department Record</h2></div>
        <div class="col-auto">
        <button type="button" class="btn outlineblue mr-2"><a href="<?php echo Router::url(['controller'=>'Departmenttable','action'=>'index']) ?>">Cancel</a></button>
  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      <div class="col-sm-3 mb-2">
          ...
          <label class="labelform">Department Id</label>  
            <input id="" value="<?= h($departmenttable->id) ?>" type="text" name="id" placeholder="" class="form-control rounded-0" width="100%"    /> 
         </div>
        </div>
        <div class="col-sm-2 mb-2">
          <div class="form-group addcustomcss">
          <label class="labelform">Department</label>  
            <input id="" value="<?= h($departmenttable->department) ?>" type="text" name="department" placeholder="" class="form-control rounded-0" width="100%"    /> 
        ...
        <div class="col-sm-3 mb-2">
          <div class="form-group addcustomcss">
          <label class="labelform">Designation Id</label>  
            <input id="" value="<?= h($departmenttable->designationId) ?>" type="text" name="designationId" placeholder="" class="form-control rounded-0" width="100%"    /> 
         </div>
        </div>
        <div class="col-sm-3 mb-2">
          <div class="form-group addcustomcss">
          <label class="labelform">Department Status</label>  
          <select id="status"  name="departmentStatus" value="<?php echo $departmenttable->departmentStatus ?>" class="form-control rounded-0">
