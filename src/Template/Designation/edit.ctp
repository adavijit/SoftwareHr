  ...
  <body>
    ...
    <div class="bodytransition">
      <div class="bodypart">
        ...
        <div class="col"><h2>Edit Designation Record</h2></div>
        <div class="col-auto">
        <button type="button" class="btn outlineblue mr-2"><a href="<?php echo Router::url(['controller'=>'Designation','action'=>'index']) ?>">Cancel</a></button>
      ...
      <div class="row">
        ...
        <div class="col-sm-2 mb-2">
          ...
          <label class="labelform">Designation</label>  
            <input id="" value="<?= h($designation->designation) ?>" type="text" name="designation" placeholder="" class="form-control rounded-0" width="100%"    /> 
        ...
        <div class="col-sm-3 mb-2">
          ...
          <label class="labelform">Department</label>  
            <input id="" value="<?= h($designation->department) ?>" type="text" name="department" placeholder="" class="form-control rounded-0" width="100%"    /> 
         </div>
        </div>
        <div class="col-sm-3 mb-2">
          <div class="form-group addcustomcss">
          <label class="labelform">Designation Status</label>  
            <select id="status"  name="designationStatus" value="<?php echo $designation->designationStatus?>" class="form-control rounded-0">
