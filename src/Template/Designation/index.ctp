...
<html lang="en">
  ...
  <body>
    ...
    <a href="javascript:void(0)" class="menuhomem"><i class="icon-add-plus-button"></i></a>
      <div class="leftpadd">
        ...
        <ul class="listofnav">
          ...
          <li>
            <a id="parent5" onclick="changeActive('parent5')" class="activeclass" href="<?php echo Router::url(['controller'=>'Designation','action'=>'index']) ?>"><i class="icon-home"></i> <span>Employe Designation</span></a>
          </li>
          <li>
    ...
    <div class="bodypart">
        ...
        <div class="col"><h2>View Designation</h2></div>
      ...
      <div class="col-auto"> <button onClick="javascipt:window.location.href='<?php echo Router::url(['controller'=>'Designation','action'=>'add']) ?>' "  type="button" class="btn outlineblue mr-2">Add Designation</button></div>
      </div>
      <div>
  ...
  <?php foreach ($designation as $designation): ?>
            ...
            <td><?= h($designation->department) ?></td>
            <td><?= h($designation->designationStatus) ?></td>
            <td class="actions">
               <?php if(strtolower($designation->designationStatus) == "active"){
                  echo " <a id='changeDiv1'  onClick='onclickFunction($designation->id,5);' style='color:red;cursor:pointer;' ><i class='icon-cancel-1'></i>  </a>";
                  echo "&nbsp;";
                }
                else{
                  echo " <a id='changeDiv2' onClick='onclickFunction($designation->id,6);' style='color:#00FF00;cursor:pointer;'><i class='icon-check-sign'></i>  </a>";
                  echo "&nbsp;";

                }?>
            
                    <a style='color:black;' href="<?php echo Router::url(['controller'=>'Designation','action'=>'edit',$designation->id]); ?>" ><i class='icon-pencil'></i>  </a>
               <?php echo "&nbsp;";?>
                    <?php echo " <a data-toggle='modal' data-target='#confirmModal'  onClick='deleteS($designation->id);' href='javascript:void(0)'><i class='icon-trash-1'></i>  </a>";
                ?></td>   
...
<div class="modal fade" id="confirmModal" tabindex="-1" role="dialog" aria-labelledby="confirmModal" aria-hidden="true">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer border-top-0 justify-content-center mb-3">
        <?php echo "<button type='button' data-dismiss='modal' aria-label='Close' onClick='onclickFunction(4,4);' class='btn bluebutton'>Yes</button>" ?>
      </div>
    </div>
  </div>
</div>
