  ...
  <div class="tab-content">
    <div id="home" class="tab-pane fade in active">
      ...
      <div class="row">
        ...
        <div class="col-sm-4 mb-2">
          <div class="form-group addcustomcss">
            <input id="" type="text" name="designationId" placeholder="Designation" class="form-control rounded-0" width="100%" /> 
          </div>
        </div>
        <div class="col-sm-4 mb-2">
          <div class="form-group addcustomcss">
          <input id="" type="text" name="department" placeholder="Department" class="form-control rounded-0" width="100%" />  
          </div>
        </div>
        <div class="col-sm-4 mb-2">
          <div class="form-group addcustomcss">
            <input id="" type="text" name="no_of_day_requested" placeholder="No. of Days Requested" class="form-control rounded-0" width="100%" /> 
          </div>
        </div>
        <div class="col-sm-4 mb-2">
          <div class="form-group addcustomcss">
        ...
        <div class="col-sm-4 mb-2">
          <div class="form-group addcustomcss">
            <input id="" type="text" name="balance_leave" placeholder="Current Leave Balance" class="form-control rounded-0" width="100%" /> 
          </div>
        </div>
        <div class="col-sm-4 mb-2">
          <div class="form-group addcustomcss">
            <input id="datepicker" name="starting_date" placeholder="Leave Starting Date" class="form-control rounded-0" width="100%" />
          </div>
        </div>
        <div class="col-sm-4 mb-2">
          <div class="form-group addcustomcss">
            <input id="datepicker2" name="ending_date" placeholder="Leave Ending Date" class="form-control rounded-0" width="100%" /> 
          </div>
        </div>
        <div class="col-sm-4 mb-2">
          <div class="form-group addcustomcss">
            <input id="" type="text" name="supervisor_name" placeholder="Supervisor Name" class="form-control rounded-0" width="100%" /> 
          </div>
        </div>
        <div class="col-sm-4 mb-2">
          <div class="form-group addcustomcss">
            <select name="approval_states" class="form-control rounded-0">
              <option>Leave Approval Status</option>
        ...
        <div class="col-sm-12 mb-2">
          <div class="form-group addcustomcss">
            <textarea type="text" name="reason" class="form-control">Reason for leave</textarea>
          </div>
        </div>
