    ...
    <div id="home" class="tab-pane fade in active">
      ...
      <div class="col-sm-4 mb-2">
          ...
          <label class="labelform">Department</label>
            ...
            <input id="department" name="department" class="form-control rounded-0" width="100%" />
        ...
        <div class="col-sm-4 mb-2">
          ...
          <label class="labelform">Designation Id</label>
            ...
            <input id="designationId" name="designationId" class="form-control rounded-0" width="100%" />
        ...
        <div class="col-sm-4 mb-2">
          ...
          <label class="labelform">Status</label>
             ...
             <select id="departmentStatus"  name="departmentStatus" class="form-control rounded-0">
